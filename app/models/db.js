...
const Homeowners = sequelize.define(
    "homeowners",
    {
        id: {
            type: Sequelize.INTEGER,
...
const WorkTickets = sequelize.define(
    "workTickets",
    {
        id: {
            type: Sequelize.INTEGER,
...
const RevenueYTD = sequelize.define(
    "revenueYTD",
    {
        id: {
            type: Sequelize.INTEGER,
...
const ExpenseYTD = sequelize.define(
    "expenseYTD",
    {
        id: {
            type: Sequelize.INTEGER,
